...
namespace RhNetAPI.Models.Shared
{
    public class MunicipioModel
    {
        ...
        [Display(AutoGenerateField =false, Name ="Id", Order =0, Description ="Id")]
        public int Id { get; set; }

        [Required(ErrorMessage = "Campo {0} obrigatório")]
        [StringLength(300, ErrorMessage = "O Campo {0} é Obrigatório e deve conter no máximo {1} Caracteres!")]
        [Display(AutoGenerateField = true, Name = "Descricao", Order = 1, Description = "Descrição")]
        public string Descricao { get; set; }

        [StringLength(10, ErrorMessage = "O Campo {0} deve conter no máximo {1} Caracter(es)!")]
        [Display(AutoGenerateField = true, Name = "Codigo_Audesp", Order = 2, Description = "Código Audesp")]
