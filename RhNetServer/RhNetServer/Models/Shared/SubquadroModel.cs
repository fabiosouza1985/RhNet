...
namespace RhNetServer.Models.Shared
{
    public class SubquadroModel
    {
        ...
        [Required(ErrorMessage = "Campo {0} obrigatório")]
        [Display(AutoGenerateField = false, Name = "Quadro", Order = 3, Description = "Quadro", AutoGenerateFilter = false)]
        public QuadroModel Quadro { get; set; }
